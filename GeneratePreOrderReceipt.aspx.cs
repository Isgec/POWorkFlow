                ...
                ////}
...

                    {
                        ...
                        string InsertParentRecord = @"Insert into tdmisg134200(t_atch,t_stat,t_sent_1,t_rece_1,t_suer,t_sdat,t_appr,
                                        ...
                                        t_apid_1,t_apid_2,t_apid_3,t_apid_4,t_apid_5,t_apid_6,t_apid_7)  
                    ...
                    string PreorderReceiptInsertionToBAAN = @"update tdmisg168200 set t_rcno = '" + RECNumber + "' where  t_wfid =" + Request.QueryString["WFID"] + " ";
                    ...
                    //System.IO.StreamWriter oTW = new System.IO.StreamWriter(@"D:\Temp\" + sFilename); //for local debugging
